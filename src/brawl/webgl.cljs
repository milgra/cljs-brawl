...
(defn init []
  {:mycontext (context/get-context (.getElementById js/document "main"))
...
(defn loadshapes [:keys [context] state shapes]
...
(defn draw [{:keys [context shader scene_buffer actor_buffer location_pos location_col] :as state} projection [tx ty]]

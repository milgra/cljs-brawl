...
(defn init [x y id color basemetrics]
  (let [bases {:base_l   (phys2/mass2 (+ x 20.0) y 2.0 1.0 0.0 0.0)
        ...
        masses {:head    (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :neck    (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :hip     (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :hand_l  (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :hand_r  (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :elbow_l (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :elbow_r (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :knee_l  (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :knee_r  (phys2/mass2 x y 4.0 1.0 0.6 0.1)
                :foot_l  (phys2/mass2 (+ x 20.0) y 4.0 1.0 0.6 0.1)
                :foot_r  (phys2/mass2 (+ x 20.0) y 4.0 1.0 0.6 0.1)}
        ...
        dguards [(phys2/dguard2 masses :head :neck (:headl metrics) 0.9)
                 ...
                 (phys2/dguard2 masses :hip :knee_l (* 0.5 (:legl metrics)) 0.9)
                 (phys2/dguard2 masses :hip :knee_r (* 0.5 (:legl metrics)) 0.9)
                 (phys2/dguard2 masses :knee_l :foot_l (* 0.5 (:legl metrics)) 0.9)
                 (phys2/dguard2 masses :knee_r :foot_r (* 0.5 (:legl metrics)) 0.9)]

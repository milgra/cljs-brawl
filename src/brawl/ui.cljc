  ...
  (let [{:keys [level ui-drawer]} state
    ...
    (cond
      ...
      (and (= text "right")(= type "up"))     (-> state
                                                  ...
                                                  (assoc-in [:keycodes 32] false))
      (and (= text "jump")(= type "down"))        (assoc-in state [:keycodes 38] true)
      (and (= text "jump")(= type "up"))          (assoc-in state [:keycodes 38] false)
      (and (= text "down")(= type "down"))        (assoc-in state [:keycodes 40] true)
      (and (= text "down")(= type "up"))          (assoc-in state [:keycodes 40] false)
      (and (= text "run")(= type "down"))         (assoc-in state [:keycodes 32] true)
      (and (= text "run")(= type "up"))           (assoc-in state [:keycodes 32] false)
      (and (= text "punch")(= type "down"))       (assoc-in state [:keycodes 70] true)
      (and (= text "punch")(= type "up"))         (assoc-in state [:keycodes 70] false)
      (and (= text "kick")(= type "down"))        (assoc-in state [:keycodes 83] true)
      (and (= text "kick")(= type "up"))          (assoc-in state [:keycodes 83] false)
      (and (= text "block")(= type "down"))       (assoc-in state [:keycodes 68] true)
      (and (= text "block")(= type "up"))         (assoc-in state [:keycodes 68] false)
      ;; main menu
